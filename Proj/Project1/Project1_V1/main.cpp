...
void gameOn() {
    ...
    cout<<"At this time, we are entering the pay out phase."<<endl;
        if (spin>0&&spin<=36){
            ...
            //Check for black
            if (spin==2||spin==4||spin==6||spin==8||spin==10||spin==11||
                     spin==13||spin==15||spin==17||spin==20||spin==22||spin==24
                    ||spin==26||spin==28||spin==29||spin==31||spin==33||spin==35){
                if (black==true){
            ...
            //Check for red
            if (spin==1||spin==3||spin==5||spin==7||spin==9||spin==12
                    ||spin==14||spin==16||spin==18||spin==19||spin==21||spin==23
        ...
        float oddsRpt=0.0263157;        //1/38 for stats odds of repeat
